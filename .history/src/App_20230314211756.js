      ...
      <table>
            ...
            index < page * row && index + 1 > (page - 1) * row ?
              (<tr>
                ...
                <td className='actionsTd'>
                  <button className='actions deleteAction' onClick={() => { setDeleteItemId(item.id); setshowModal(true); setmodalAccept(2) }}>
        ...
        <tr className='addingInput'>
          ...
          <th className='addingTh'>
            <button className='actions addAction' onClick={() => { setmodalHeader("https://www.freeiconspng.com/thumbs/add-icon-png/add-1-icon--flatastic-1-iconset--custom-icon-design-0.png")
