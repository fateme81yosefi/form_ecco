...
function App() {
  ...
  const [modalBody, setsearchIn] = useState("");
  const [modalFooter, setsearchIn] = useState("");
  ...
  return <div className="App">
    <div className='containerr'>
      <div className='moddal'>
        ...
        <div className='moddalBody'> jaflakeghae</div>
        <div className='moddalFooter'><button>slkd</button></div>
      </div>
