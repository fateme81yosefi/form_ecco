...
function App() {
  ...
  const [showModal, setmodalAccept] = useState(false);
  ...
  return <div className="App">
    <div className='containerr'>
      <div className='moddal'>
        ...
        <div className='moddalFooter'><button className='yesButton' onClick={() => setmodalAccept(true)}>بله</button><button className='noButton' onClick={() => setmodalAccept(false)}>خیر</button></div>
      </div>
