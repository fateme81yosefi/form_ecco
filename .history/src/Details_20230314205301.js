...
export default function Details() {
    ...
    //این دیتا محصول با آیدی مشخص شده رو میگیره
    ...
    //از روی پت براوزر آیدی رو پیدا میکنیم
    useEffect(() => {
    ...
    //بصورت آنلاین قیمت رو چک میکنه تا حتما عددی باشد
    ...
    //عملیات ادیت قیمت رو انجام میده
