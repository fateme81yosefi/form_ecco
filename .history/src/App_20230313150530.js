  ...
  return <div className="App">
    <div className='containerr'>
      <div className='moddal'>
        ...
        <div className='moddalFooter'><button className='yesButton' onClick={() => modalAccept(true)}>بله</button><button className='noButton' onClick={() => modalAccept(true)}>خیر</button></div>
      </div>
