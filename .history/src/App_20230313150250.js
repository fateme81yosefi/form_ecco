...
function App() {
  ...
  const [modalHeader, setmodalHeader] = useState("https://www.freeiconspng.com/thumbs/add-icon-png/add-1-icon--flatastic-1-iconset--custom-icon-design-0.png");
  ...
  return <div className="App">
    <div className='containerr'>
      <div className='moddal'>
        ...
        <div className='moddalFooter'><button className='yesButton'>بله</button><button className='noButton'>خیر</button></div>
      </div>
