  ...
  return <div className="App">
    <div className='containerr'>
      {showModal && <div className='moddal'>
        ...
        <div className='moddalFooter'><button className='yesButton' onClick={() => setmodalAccept(true)}>بله</button><button className='noButton' onClick={() => set(false)}>خیر</button></div>
      </div>}
