  ...
  return <div className="App">
    <div className='containerr'>
      ...
      {showModal && <div className='moddal'>
        ...
        <div className='moddalFooter'><button className='yesButton' onClick={() => { handleModalRequest()setmodalAccept(true); setshowModal(false) }}>بله</button><button className='noButton' onClick={() => setshowModal(false)}>خیر</button></div>
      </div>}
