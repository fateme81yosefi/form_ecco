      ...
      <table>
            ...
            index < page * row && index + 1 > (page - 1) * row ?
              (<tr>
                ...
                <td className='actionsTd'>
                  <button className='actions deleteAction' onClick={() => { setDeleteItemId(item.id); setshowModal(true);setmodalAccept }}>
        ...
        <tr className='addingInput'>
          ...
          <th className='addingTh'>
            <button className='actions addAction' onClick={() => { setshowModal(true); setmodalAccept(1) }}>
