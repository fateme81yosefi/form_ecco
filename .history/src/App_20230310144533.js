...
function App() {
  ...
  useEffect(() => {
    ...
    console.log("Math.ceil(DataFiltered.length / row) : ", Math.ceil(DataFiltered.length / row))

    console.log("Math.ceil(Data.length / row) : ", Math.ceil(Data.length / row))
      ...
      <table>
        ...
        <tr className='addingInput'>
          ...
          <th> <div className="dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="dropdownMenuButton">
              <a className="dropdown-item" onClick={() => { setNewProcuctCategory("شناسه"); setTitleSearch("شناسه") }}>شناسه</a>
              <a className="dropdown-item" onClick={() => { setNewProcuctCategory("دسته بندی"); setTitleSearch("دسته بندی") }} >دسته بندی </a>
              <a className="dropdown-item" onClick={() => { setNewProcuctCategory("نام "); setTitleSearch("نام") }}>نام</a>
