  ...
  return <div className="App">
    <div className='containerr'>
      <div className='moddal'>
        ...
        <div className='moddalFooter'><button className='yesButton' onClick={() => setmodalAccept(true)}>بله</button><button className='noButton' onClick={() => modalAccept(false)}>خیر</button></div>
      </div>
