...
function App() {
  ...
  const EditPage = (id) => {
    ...
    setmodalHeader("https://banner2.cleanpng.com/20180421/kae/kisspng-computer-icons-editing-editable-background-5adbd7f8de48f6.2968994415243571129105.jpg")
            ...
            index < page * row && index + 1 > (page - 1) * row ?
              (<tr>
                ...
                <td className='actionsTd'>
                  ...
                  <button className='actions editAction' onClick={() => { EditPage(item.id); setshowModal(true) }}>
