...
function App() {
  ...
  const addProduct = async () => {
    setmodalHeader("https://www.freeiconspng.com/thumbs/add-icon-png/add-1-icon--flatastic-1-iconset--custom-icon-design-0.png")
      setmodalBody("آیا میخواهید این آیتم را اضافه کنید؟") if (modalAccept) {
  ...
  return <div className="App">
    <div className='containerr'>
      <div className='moddal'>
        ...
        <div className='moddalFooter'><button className='yesButton' onClick={() => modalAccept(true)}>بله</button><button className='noButton' onClick={() => modalAccept(false)}>خیر</button></div>
      </div>
