  ...
  const addProduct = async () => {
    if (window.confirm('Do you want to Add it?')) {
      ...
      try {
       ...
       setData((x)=>[...x,{id: newProcuctId, price: newProcuctPrice, description: newProcuctDescription, category: newProcuctCategory }])
       setEmpty(!empty)
    ...
    <div className='containerr'>
      ...
      <table>
        ...
        <tr className='addingInput'>
          <th><input placeholder='= شناسه' onChange={(e) => { setNewProcuctCategory(e.target.value) }} /></th>
